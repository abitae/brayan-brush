...
const AboutSection: React.FC<AboutProps> = ({ companyName }) => {
  return (
        ...
        <div className="flex flex-col lg:flex-row items-center gap-20">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="space-y-6 text-slate-600 text-lg leading-relaxed font-medium">
              <p>
                <b>{companyName}</b> es más que una empresa de transporte; somos su socio estratégico. Gracias a nuestro panel de control centralizado, gestionamos cada unidad con precisión quirúrgica.
              </p>
              <p>

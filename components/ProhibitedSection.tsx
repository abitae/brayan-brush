...
const ProhibitedSection: React.FC<ProhibitedProps> = ({ items = [], onSwitchToContact }) => {
  return (
    <section className="py-24 bg-slate-50 min-h-[70vh]">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          <span className="text-rose-600 font-bold uppercase tracking-widest text-sm mb-4 block">Seguridad en el transporte</span>

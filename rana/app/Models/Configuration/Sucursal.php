...
class Sucursal extends Model
{
    ...
    public function rutas_sucursal_origen()
    {
        return $this->hasMany(RutaSucursal::class, 'sucursal_origen_id');
    }
    public function rutas_sucursal_destino()
    {
        return $this->hasMany(RutaSucursal::class, 'sucursal_destino_id');
    }
}
